...
EXPECTED_FIELDS = {
    "session_key", "order", "fuel", "start_ms", "end_ms", "rpm", "map_bar",
    "petrol_ms", "window_count", "rpm_bin", "map_bin",
}
...
class RealCorpusBlendTest(unittest.TestCase):
    ...
    def test_real_gasoline_regions_are_analyzed_without_claiming_transfer(self):
        ...
        self.assertEqual(report.analyzed_regions, report.unimodal_regions + report.multimodal_regions + report.ambiguous_regions)

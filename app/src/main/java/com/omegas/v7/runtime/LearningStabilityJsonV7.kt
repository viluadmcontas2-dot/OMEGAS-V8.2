...
object LearningStabilityJsonV7 {
    ...
    private fun snapshotJson(value: LearningStabilitySnapshotV7): JSONObject = JSONObject()
        ...
        .put("consolidatedSupportMass", value.consolidatedSupportMass)
        .put("recentSupportMass", value.recentSupportMass)
        .put("consolidatedKishEss", value.consolidatedKishEss)
        .put("recentKishEss", value.recentKishEss)

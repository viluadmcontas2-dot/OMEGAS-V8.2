 ...
 * mutável. RPM não é usado como proxy de movimento: com a ECU/USB saudáveis e
 * telemetria fresca, a rotação por si só não bloqueia uma gravação manual.
 * A confirmação humana continua sendo uma etapa separada e obrigatória.
 */

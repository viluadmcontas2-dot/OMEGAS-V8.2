  ...
  (function(root) {
    ...
    class SplitLayout {
      ...
      apply() {
        ...
        this.shell.style.setProperty("--viewport-width", "".concat(width, "px"));
        this.shell.style.setProperty("--viewport-height", "".concat(height, "px"));
      }
      destroy() {
    ...
    function boot() {
      ...
      if (!(app == null ? void 0 : app.store) || !(app == null ? void 0 : app.router)) {

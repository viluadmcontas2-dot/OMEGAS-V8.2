  ...
  (function(root) {
    ...
    class ObdScreen {
      ...
      bind() {
        ...
        document.getElementById("obdGnvEnableButton")?.addEventListener("click", () => this.api.setObdGnvLearningEnabled(true));
        document.getElementById("obdGnvDisableButton")?.addEventListener("click", () => this.api.setObdGnvLearningEnabled(false));

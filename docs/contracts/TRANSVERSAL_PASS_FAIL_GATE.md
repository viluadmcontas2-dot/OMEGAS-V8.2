...
The live **Notion Contract Registry is canonical**. This GitHub contract is an enforcement surface and minimum coverage set; it does not fork or replace the Registry.

Before any verdict, executor and independent auditor must:

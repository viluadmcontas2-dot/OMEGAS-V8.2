...
- Current APK receipt: **GENERATED BY OWNER-AUTHORIZED RERUN** for source SHA `e6b290411592bbdaa7863d1669b2dc9534c25739`
...
That software-closure run did not generate an APK. A later owner-authorized rerun of the final documentation workflow did: run `34420819385`, attempt 2, completed successfully with authorization mode `owner_rerun`. It produced artifact `omegas-blue-e6b290411592bbdaa7863d1669b2dc9534c25739` (ID `10131232877`) from exact source SHA `e6b290411592bbdaa7863d1669b2dc9534c25739`.

Current APK receipt:
- APK path: `app/build/outputs/apk/debug/app-debug.apk`;
- APK size: `4,351,710` bytes;
- APK SHA256: `fb847d8f024d870262718d4ef5607a75e0e4ecbf517e70bfe7113317a38786d9`;
- uploaded ZIP digest: `6c902f20f1ad0f7d7ac9b77b61e9b19b4c58287927b6200d09a5511bdb32a42e`;
- artifact expiry: `2026-09-13T00:36:42Z`;
...
It is not an artifact of `da8f25f...` or of later documentation commits. The current owner-rerun artifact listed above is separate and belongs exactly to `e6b2904...`.
...
Final documentation source SHA `e6b290411592bbdaa7863d1669b2dc9534c25739` reached terminal success in run `34420819385`, attempt 2: FAST `success`, FULL JVM/lint `success`, and owner-authorized APK artifact `success`. The APK was generated only because the owner reran the workflow; this reconciliation commit changes documentation only and does not generate or relabel another APK.

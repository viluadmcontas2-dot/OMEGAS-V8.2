...
assert.equal(cockpit.includes('<summary>Reset avançado</summary>'), true);
...
assert.equal(cockpit.includes('ACK e readback'), true);
...
assert.equal(cockpit.includes('data-autocal-reacquire-point'), true);
...
assert.equal(cockpit.includes('Readquirir este ponto'), true);
